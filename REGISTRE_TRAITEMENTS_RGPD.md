# Registre des Traitements RGPD — LocImmo

**Responsable du traitement :** LocImmo — Projet M2 Lead Dev Full Stack 2025-2026
**DPO fictif désigné :** dpo@LocImmo.local
...
| **Destinataires** | Application LocImmo uniquement |
...
## Traitement 3 — Inscription aux annonces

| Champ | Détail |
|---|---|
| **Finalité** | Gérer les inscriptions des participants aux annonces |
| **Base légale** | Exécution d'un contrat (Art. 6.1.b RGPD) |
| **Données concernées** | Identifiant utilisateur, identifiant annonce, date d'inscription, statut |
| **Destinataires** | Organisateur de l'annonce, administrateurs |
| **Durée de conservation** | 3 ans après l'annonce |
| **Mesures de sécurité** | Accès restreint par rôle (Voter Symfony), authentification JWT requise |

---

## Traitement 4 — Création et gestion d'annonces

| Champ | Détail |
|---|---|
| **Finalité** | Permettre aux organisateurs de publier et gérer leurs annonces |
| **Base légale** | Exécution d'un contrat (Art. 6.1.b RGPD) |
...
| **Durée de conservation** | 5 ans après la date de l'annonce |
