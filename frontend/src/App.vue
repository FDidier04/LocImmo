...
const language = ref(localStorage.getItem("locimmo-language") || "fr")
...
const labels = {
  fr: {
    ...
    heroLabel: "Offres immobilières au Congo",
    heroTitleLine1: "Trouver un bien,",
    heroTitleLine2: "simplement.",
    heroCopy: "LocImmo centralise les offres immobilières en République du Congo, avec une expérience moderne et sécurisée.",
  ...
  en: {
    ...
    darkMode: "Dark mode",
    heroLabel: "Real estate offers in Congo",
    heroTitleLine1: "Find a property,",
    heroTitleLine2: "simply.",
    heroCopy: "LocImmo centralizes real estate offers in the Republic of Congo, with a modern and secure experience.",
...
watch(
  language,
  (value) => {
    localStorage.setItem("locimmo-language", value)
    ...
    <header class="sticky top-0 z-30 border-b backdrop-blur-xl" style="background:var(--bg-nav);border-color:var(--border)">
      <div class="mx-auto flex h-16 max-w-7xl items-center justify-between gap-6 px-6">
        <router-link to="/" class="flex shrink-0 items-center gap-3">
          <div class="grid h-8 w-8 place-items-center rounded-lg bg-orange-500 text-sm font-black text-white">LI</div>
