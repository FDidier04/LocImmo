...
const labels = {
  fr: {
    ...
    heroCopy: "LocImmo centralise les offres immobilieres au Congo, au Gabon, au Cameroun et au Senegal, avec une experience moderne et securisee.",
  ...
  en: {
    ...
    heroCopy: "LocImmo centralizes real estate offers in Congo, Gabon, Cameroon and Senegal, with a modern and secure experience.",
