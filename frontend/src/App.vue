...
const labels = {
  fr: {
    ...
    heroCopy: "LocImmo centralise les offres immobilieres au Congo, au Gabon, au Cameroun, au Senegal et en Cote d'Ivoire, avec une experience moderne et securisee.",
  ...
  en: {
    ...
    heroCopy: "LocImmo centralizes real estate offers in Congo, Gabon, Cameroon, Senegal and Cote d'Ivoire, with a modern and secure experience.",
