  ...
  <section class="max-w-5xl mx-auto space-y-8">
    ...
    <div class="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
      <section class="glass p-6">
        ...
        <h2 class="text-2xl font-extrabold text-main">Equipe LocImmo</h2>
        <div class="mt-5 space-y-4 text-sm text-sub">
          <p>
            <span class="text-muted">Email :</span>
            <strong class="text-main ml-2">contact@LocImmo.local</strong>
          </p>
          <p>
        ...
        <div class="mt-6 rounded-2xl border p-4 text-sm text-sub"
          ...
          contacter a propos d'un annonce.
        </div>
      </section>
        ...
        <form class="space-y-5" @submit.prevent="submit">
          <div class="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <input v-model="form.name" class="LI-input" placeholder="Votre nom" />
            ...
            <div>
              ...
              <input v-model="form.email" type="email" class="LI-input" placeholder="vous@exemple.com" />
          ...
          <div>
            ...
            <input v-model="form.subject" class="LI-input" placeholder="Ex: Besoin d'assistance" />
