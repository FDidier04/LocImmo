  ...
  <div class='min-h-[70vh] flex items-center justify-center py-12'>
    <div class='w-full max-w-md'>
      <div class='text-center mb-10'>
        ...
        <p class='text-sub text-sm mt-2'>Accédez à votre espace Immo Hub</p>
      </div>
      ...
      <div class='glass p-8'>
        <form @submit.prevent='submit' class='space-y-5'>
          <div>
            ...
            <input v-model='form.email' type='email' class='LI-input' placeholder='email@exemple.com' autocomplete='email' required />
          </div>
          <div>
            <label class='block text-xs font-semibold text-muted uppercase tracking-wider mb-2'>Mot de passe</label>
            <input v-model='form.password' type='password' class='LI-input' placeholder='••••••••' autocomplete='current-password' required />
          </div>
